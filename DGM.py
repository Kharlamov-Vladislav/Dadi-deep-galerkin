...
class LSTMLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, output_dim, input_dim, trans1 = "tanh", trans2 = "tanh"):
        ...
        super(LSTMLayer, self).__init__(dtype=tf.float64)
...
class DenseLayer(tf.keras.layers.Layer):
    ...
    def __init__(self, output_dim, input_dim, transformation=None):
        ...
        super(DenseLayer,self).__init__(dtype=tf.float64)
        self.output_dim = output_dim
        self.input_dim = input_dim
...
class DGMNet(tf.keras.Model):
    ...
    # constructor/initializer function (automatically called when new instance of class is created)
    def __init__(self, layer_width, n_layers, input_dim, params_dim, final_trans=None):
        '''
        Args:
            layer_width: 
        ...
        self.initial_layer = DenseLayer(layer_width, input_dim + params_dim + 1, transformation = "relu")
        ...
        for _ in range(self.n_layers):
            self.LSTMLayerList.append(LSTMLayer(layer_width, input_dim + params_dim + 1))
    ...
    def call(self,t,x, params):
        ...
        Args:
            ...
            params: sampled parameters inputs

        Run the DGM model and obtain fitted function value at the inputs (t,x, params)                
        '''  
        
        # define input vector as time-space pairs
        X = tf.concat([t] + x + params,1)
